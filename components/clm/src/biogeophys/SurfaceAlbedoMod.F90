...
#include "shr_assert.h"
  ...
  use clm_varctl        , only : fsurdat, iulog, subgridflag, use_snicar_frc, use_ed, use_snicar_ad  
...
contains
  ...
  subroutine SurfaceAlbedo(bounds,     &
    ...
    use abortutils         , only : endrun
    use clm_varctl         , only : iulog, subgridflag, use_snicar_frc, use_snicar_ad, use_ed
